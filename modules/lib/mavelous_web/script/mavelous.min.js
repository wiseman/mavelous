...
g=e[!0];g.remaining_=g.count_;for(var m=n.length-1;!l.propagationStopped_&&0<=m&&g.remaining_;m--)l.currentTarget=n[m],f&=goog.events.fireListeners_(g,n[m],d,!0,l);if(k){g=e[!1];g.remaining_=g.count_;for(m=0;!l.propagationStopped_&&m<n.length&&g.remaining_;m++)l.currentTarget=n[m],f&=goog.events.fireListeners_(g,n[m],d,!1,l)}}else f=goog.events.fireListener(c,l)}finally{n&&(n.length=0)}return f}d=new goog.events.BrowserEvent(b,this);return f=goog.events.fireListener(c,d)};
