...
Mavelous.StatustextView.prototype.onStatusTextChange=function(){clearTimeout(this.timeout);var a=this.$el;a.html(this.statusText.get("text"));a.css("padding",10);this.timeout=setTimeout(function(){a.html("");a.css("padding",0)},4E3)};Mavelous.GpsTextView={};Mavelous.GpsButtonView=function(a){this.popoverTitle="GPS Info";Backbone.View.call(this,a)};goog.inherits(Mavelous.GpsButtonView,Backbone.View);Mavelous.GpsButtonView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.gps=a.subscribe("GPS_RAW_INT",this.onGPS_,this);this.stat=a.subscribe("GPS_STATUS",this.onStatus_,this)};goog.exportSymbol("Mavelous.GpsButtonView.prototype.initialize",Mavelous.GpsButtonView.prototype.initialize);
Mavelous.GpsButtonView.prototype.registerPopover=function(a){this.popover=a;this.popover.on("selected",this.renderPopover,this)};
Mavelous.GpsButtonView.prototype.renderFixType_=function(a){this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse");var b="btn-inverse",c="GPS: None";3<=a?(b="btn-success",c="GPS: 3D"):2==a?(b="btn-warning",c="GPS: 2D"):1==a&&(b="btn-danger",c="GPS: No Lock");this.$el.addClass(b);c='<span class="hidden-phone">'+c+'</span><i class="icon-globe icon-white visible-phone"></i>';this.$el.html(c)};
Mavelous.GpsButtonView.prototype.onGPS_=function(){var a=this.gps.get("fix_type");this.renderFixType_(a);this.renderPopover()};Mavelous.GpsButtonView.prototype.onStatus_=function(){this.renderPopover()};
Mavelous.GpsButtonView.prototype.renderPopover=function(){var a=this.stat.toJSON(),b=(this.gps.get("lat")/1E7).toFixed(7),c=(this.gps.get("lon")/1E7).toFixed(7),d="";"satellites_visible"in a&&(d+="Satellites: "+a.satellites_visible.toString()+"<br /> Coordinates: "+b+", "+c);a=this.gps.get("eph");"undefined"!=typeof a&&65535!=a&&(d+="<br />HDOP: "+(a/100).toFixed(2)+"m");a=this.gps.get("epv");"undefined"!=typeof a&&65535!=a&&(d+="<br />VDOP: "+(a/100).toFixed(2)+"m");this.popover&&this.popover.trigger("content",
d)};goog.json={};goog.json.isValid_=function(a){return/^\s*$/.test(a)?!1:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,""))};goog.json.parse=function(a){a=String(a);if(goog.json.isValid_(a))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);};goog.json.unsafeParse=function(a){return eval("("+a+")")};
...
Mavelous.PFDSettingsModel.prototype.readFromCookie=function(){var a=$.cookie("pfdSettings");if(a){window.console.log("cookieData");window.console.log(a);try{return goog.json.parse(a)}catch(b){return window.console.warn("Unable to parse pfdSettings cookie data:"),window.console.warn(a),null}}else return null};Mavelous.PFDSettingsModel.prototype.writeToCookie=function(){var a=goog.json.serialize(this.toJSON());window.console.log("writeToCookie:");window.console.log(a);$.cookie("pfdSettings",a)};Mavelous.SettingsView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.SettingsView,Backbone.View);
Mavelous.SettingsView.prototype.initialize=function(){var a=this;this.modalToggle=this.options.modalToggle;this.modal=this.options.modal;this.modalToggle.click(function(){a.modal.modal("toggle")});this.map=this.options.map;this.mapProviderModel=this.options.mapProviderModel;this.vehicleIconModel=this.options.vehicleIconModel;this.mapProviderPicker=this.options.mapProviderPicker;this.mapZoomSlider=this.options.mapZoomSlider;this.mapZoomValue=this.options.mapZoomValue;this.vehicleIconPicker=this.options.vehicleIconPicker;
this.setupMapProviderPicker();this.setupMapZoomSlider();this.setupVehicleIconPicker();this.pfdSettingsModel=this.options.pfdSettingsModel;this.pfdPositionLeft=this.options.pfdPositionLeft;this.pfdPositionRight=this.options.pfdPositionRight;this.pfdPositionUp=this.options.pfdPositionUp;this.pfdPositionDown=this.options.pfdPositionDown;this.setupPFDSettings()};goog.exportSymbol("Mavelous.SettingsView.prototype.initialize",Mavelous.SettingsView.prototype.initialize);
Mavelous.SettingsView.prototype.setupMapProviderPicker=function(){var a=this;void 0!==this.mapProviderModel&&(_.each(Mavelous.LeafletProviders.Providers,function(b,c){a.mapProviderPicker.append('<option value="'+c+'">'+b.description+"</option>")}),this.mapProviderPicker.change(function(){var b=a.mapProviderPicker.val();a.mapProviderModel.set("provider",b)}))};
Mavelous.SettingsView.prototype.setupMapZoomSlider=function(){var a=this;void 0!==this.map&&(this.mapZoomSlider.change(function(){a.map.setZoom(a.mapZoomSlider.val())}),this.map.on("zoomend",this.onZoomChange,this))};
...
goog.string.compareVersions=function(a,b){for(var c=0,d=goog.string.trim(String(a)).split("."),e=goog.string.trim(String(b)).split("."),f=Math.max(d.length,e.length),g=0;0==c&&g<f;g++){var h=d[g]||"",j=e[g]||"",k=RegExp("(\\d*)(\\D*)","g"),m=RegExp("(\\d*)(\\D*)","g");do{var n=k.exec(h)||["","",""],l=m.exec(j)||["","",""];if(0==n[0].length&&0==l[0].length)break;var c=0==n[1].length?0:parseInt(n[1],10),p=0==l[1].length?0:parseInt(l[1],10),c=goog.string.compareElements_(c,p)||goog.string.compareElements_(0==
n[2].length,0==l[2].length)||goog.string.compareElements_(n[2],l[2])}while(0==c)}return c};goog.string.compareElements_=function(a,b){return a<b?-1:a>b?1:0};goog.string.HASHCODE_MAX_=4294967296;goog.string.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c),b%=goog.string.HASHCODE_MAX_;return b};goog.string.uniqueStringCounter_=2147483648*Math.random()|0;goog.string.createUniqueString=function(){return"goog_"+goog.string.uniqueStringCounter_++};
...
goog.events.handleBrowserEvent_=function(a,b){if(!goog.events.listeners_[a])return!0;var c=goog.events.listeners_[a],d=c.type,e=goog.events.listenerTree_;if(!(d in e))return!0;var e=e[d],f,g;if(!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT){f=b||goog.getObjectByName("window.event");var h=!0 in e,j=!1 in e;if(h){if(goog.events.isMarkedIeEvent_(f))return!0;goog.events.markIeEvent_(f)}var k=new goog.events.BrowserEvent;k.init(f,this);f=!0;try{if(h){for(var m=[],n=k.currentTarget;n;n=n.parentNode)m.push(n);
g=e[!0];g.remaining_=g.count_;for(var l=m.length-1;!k.propagationStopped_&&0<=l&&g.remaining_;l--)k.currentTarget=m[l],f&=goog.events.fireListeners_(g,m[l],d,!0,k);if(j){g=e[!1];g.remaining_=g.count_;for(l=0;!k.propagationStopped_&&l<m.length&&g.remaining_;l++)k.currentTarget=m[l],f&=goog.events.fireListeners_(g,m[l],d,!1,k)}}else f=goog.events.fireListener(c,k)}finally{m&&(m.length=0)}return f}d=new goog.events.BrowserEvent(b,this);return f=goog.events.fireListener(c,d)};
...
Mavelous.PacketLossModel.prototype.diff=function(a,b,c){return{master_in:a.master_in-b.master_in,master_out:a.master_out-b.master_out,mav_loss:a.mav_loss-b.mav_loss,period:c}};Mavelous.CommStatusButtonView=function(a){this.popoverTitle="Link Info";Backbone.View.call(this,a)};goog.inherits(Mavelous.CommStatusButtonView,Backbone.View);
Mavelous.CommStatusButtonView.prototype.initialize=function(){this.commStatusModel=this.options.commStatusModel;this.packetLossModel=this.options.packetLossModel;this.commStatusModel.bind("change",this.buttonRender,this);this.packetLossModel.bind("change",this.popoverRender,this)};goog.exportSymbol("Mavelous.CommStatusButtonView.prototype.initialize",Mavelous.CommStatusButtonView.prototype.initialize);
Mavelous.CommStatusButtonView.prototype.registerPopover=function(a){this.popover=a;this.popover.on("selected",this.popoverRender,this)};
...
b="Link: Error");this.$el.addClass(c);b='<span class="hidden-phone">'+b+'</span><i class="icon-signal icon-white visible-phone"></i>';this.$el.html(b)};Mavelous.CommStatusButtonView.prototype.packetLossString_=function(a){return"In last "+a.period+"s, "+a.master_in+" packets received, "+a.master_out+" sent, "+a.mav_loss+" lost"};Mavelous.CommStatusButtonView.prototype.popoverRender=function(){var a=this.packetLossModel.getDelta(),b=this.packetLossString_(a);this.popover&&this.popover.content(function(a){a.html(b)})};Mavelous.SelectedModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.SelectedModel,Backbone.Model);Mavelous.SelectedModel.prototype.defaults=function(){return{selected:!1}};goog.exportSymbol("Mavelous.SelectedModel.prototype.defaults",Mavelous.SelectedModel.prototype.defaults);Mavelous.SelectedModel.prototype.select=function(){this.set("selected",!0)};Mavelous.SelectedModel.prototype.deselect=function(){this.set("selected",!1)};
Mavelous.RadioButtonPopoverView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.RadioButtonPopoverView,Backbone.View);Mavelous.RadioButtonPopoverView.prototype.initialize=function(){this.buttons=_.map(this.options.popovers,goog.bind(this.registerButton,this))};goog.exportSymbol("Mavelous.RadioButtonPopoverView.prototype.initialize",Mavelous.RadioButtonPopoverView.prototype.initialize);
Mavelous.RadioButtonPopoverView.prototype.registerButton=function(a,b){var c=new Mavelous.SelectedModel;c.set("index",b);a.$el.click(goog.bind(this.onButtonClick,this,b));a.selectedModel=c;c.bind("change",a.onSelectedChange,a);return c};Mavelous.RadioButtonPopoverView.prototype.onButtonClick=function(a){this.buttons[a].get("selected")?this.buttons[a].deselect():(this.buttons[a].select(),_.each(_.without(this.buttons,this.buttons[a]),function(a){a.deselect()}))};
Mavelous.PopoverView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.PopoverView,Backbone.View);Mavelous.PopoverView.prototype.initialize=function(){_.extend(this,Backbone.Events);this.$el=this.options.button.$el;var a=this.options.button.popoverTitle;"undefined"==typeof a&&(a="need a popoverTitle in button view!");this.$el.popover({animation:!1,placement:"bottom",title:a,trigger:"manual"});this.on("content",this.onContent,this);this.options.button.registerPopover(this)};
goog.exportSymbol("Mavelous.PopoverView.prototype.initialize",Mavelous.PopoverView.prototype.initialize);Mavelous.PopoverView.prototype.onSelectedChange=function(){this.selectedModel.get("selected")?this.trigger("selected",!0):this.$el.popover("hide")};Mavelous.PopoverView.prototype.onContent=function(a){this.selectedModel.get("selected")&&this.$el.popover("show",function(b){b.find(".popover-content > *").html(a)})};
Mavelous.PopoverView.prototype.element=function(a){this.selectedModel.get("selected")&&this.$el.popover("show",a)};Mavelous.PopoverView.prototype.content=function(a){this.element(function(b){a(b.find(".popover-content > *"))})};Mavelous.StatusButtons=function(a){return new Mavelous.RadioButtonPopoverView({popovers:goog.array.map(a,function(a){return new Mavelous.PopoverView({button:a})})})};goog.dom={};goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);a.className=c.join(" ");return c.length==e};
...
goog.math.Coordinate.magnitude=function(a){return Math.sqrt(a.x*a.x+a.y*a.y)};goog.math.Coordinate.azimuth=function(a){return goog.math.angle(0,0,a.x,a.y)};goog.math.Coordinate.squaredDistance=function(a,b){var c=a.x-b.x,d=a.y-b.y;return c*c+d*d};goog.math.Coordinate.difference=function(a,b){return new goog.math.Coordinate(a.x-b.x,a.y-b.y)};goog.math.Coordinate.sum=function(a,b){return new goog.math.Coordinate(a.x+b.x,a.y+b.y)};goog.dom.ASSUME_QUIRKS_MODE=!1;goog.dom.ASSUME_STANDARDS_MODE=!1;goog.dom.COMPAT_MODE_KNOWN_=goog.dom.ASSUME_QUIRKS_MODE||goog.dom.ASSUME_STANDARDS_MODE;goog.dom.NodeType={ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY_REFERENCE:5,ENTITY:6,PROCESSING_INSTRUCTION:7,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10,DOCUMENT_FRAGMENT:11,NOTATION:12};goog.dom.getDomHelper=function(a){return a?new goog.dom.DomHelper(goog.dom.getOwnerDocument(a)):goog.dom.defaultDomHelper_||(goog.dom.defaultDomHelper_=new goog.dom.DomHelper)};
...
goog.net.jsloader.load=function(a,b){var c=b||{},d=c.document||document,e=goog.dom.createElement(goog.dom.TagName.SCRIPT),f={script_:e,timeout_:void 0},g=new goog.async.Deferred(goog.net.jsloader.cancel_,f),h=null,j=goog.isDefAndNotNull(c.timeout)?c.timeout:goog.net.jsloader.DEFAULT_TIMEOUT;0<j&&(h=window.setTimeout(function(){goog.net.jsloader.cleanup_(e,!0);g.errback(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.TIMEOUT,"Timeout reached for loading script "+a))},j),f.timeout_=h);e.onload=
...
Mavelous.ArtificialHorizon.prototype.setPitchRoll=function(a,b){this.pitch=a;this.roll=b};Mavelous.Tape=function(a){this.initTape_(a);Kinetic.Shape.call(this,a)};goog.inherits(Mavelous.Tape,Kinetic.Shape);Mavelous.Tape.WIDTH=30;Mavelous.Tape.HEIGHT=140;
Mavelous.Tape.prototype.initTape_=function(a){var b=Mavelous.Tape.WIDTH,c=Mavelous.Tape.HEIGHT;this.setDefaultAttrs({width:b,height:c,fontFamily:"Calibri",fontSize:12,fontStyle:"normal",side:Mavelous.Tape.SideType.LEFT});this.value=0;this.targetValue=null;this.valueText="0";Kinetic.Shape.call(this,a);this._setDrawFuncs();this.instantaneousPolygon=new Kinetic.Polygon({points:this.reflect_([0,60*c/140,25*b/30,60*c/140,b,c/2,25*b/30,80*c/140,0,80*c/140,0,60*c/140]),stroke:a.fontColor,strokeWidth:1,fill:a.instantaneousBackgroundColor});
this.bug=new Kinetic.Polygon({x:0,y:0,points:this.reflect_([31*b/30,0,34*b/30,-2*c/140,36*b/30,-2*c/140,36*b/30,2*c/140,34*b/30,2*c/140,31*b/30,0]),stroke:a.bugColor,fill:a.bugColor,strokeWidth:1})};Mavelous.Tape.prototype.reflect1_=function(a){var b=this.getAttrs();return b.side===Mavelous.Tape.SideType.RIGHT?b.width-a:a};Mavelous.Tape.prototype.reflect_=function(a){var b=this.getAttrs();if(b.side===Mavelous.Tape.SideType.RIGHT)for(var b=b.width,c=a.length,d=0;d<c;d+=2)a[d]=b-a[d];return a};
Mavelous.Tape.prototype.setValue=function(a){if(a!=this.value){this.value=a;var b="ERR";goog.isDefAndNotNull(a)&&(b=a.toString());3<b.length&&(b=b.substring(0,3),"."==b.charAt(b.length-1)&&(b=b.substr(0,b.length-1)));this.valueText=b}};Mavelous.Tape.prototype.setTargetValue=function(a){this.targetValue=a};
Mavelous.Tape.prototype.drawFunc=function(a){var b=Mavelous.Tape.WIDTH,c=Mavelous.Tape.HEIGHT,d=this.getAttrs();a.beginPath();a.fillStyle=d.backgroundColor;a.rect(0,0,30,140);a.closePath();this.fillStroke(a);var e=this.value-c/4,e=2*Math.ceil(e/2),e=Math.max(0,e),f=this.value+c/4,f=2*Math.floor(f/2),g="normal "+0.9*d.fontSize+"pt "+d.fontFamily;a.font=g;a.fillStyle=d.fontColor;a.strokeStyle=d.fontColor;a.textBaseLine="top";a.textAlign=d.side===Mavelous.Tape.SideType.LEFT?"right":"left";for(g=d.fontSize/
2;e<=f;e+=2){var h=c/2+2*(this.value-e);if(0.001>e%10||0.001>10-e%10){a.beginPath();a.moveTo(this.reflect1_(25*b/30),h);a.lineTo(this.reflect1_(b),h);a.stroke();var j=""+Math.round(e);a.beginPath();a.fillText(j,this.reflect1_(23*b/30),h+g)}else a.beginPath(),a.moveTo(this.reflect1_(28*b/30),h),a.lineTo(this.reflect1_(b),h),a.stroke()}this.instantaneousPolygon.drawFunc(a);c=d.height/2;g="normal "+d.fontSize+"pt "+d.fontFamily;a.font=g;a.textBaseline="middle";a.beginPath();a.fillText(this.valueText,
this.reflect1_(25*b/30),c);goog.isDefAndNotNull(this.targetValue)&&(this.reflect1_(0),b=70-2*this.targetValue,b+=2*this.value,b=Math.min(162,Math.max(16,b)),a.translate(0,b),this.bug.drawFunc(a),a.translate(0,-b))};goog.exportSymbol("Mavelous.Tape.prototype.drawFunc",Mavelous.Tape.prototype.drawFunc);Mavelous.Tape.SideType={LEFT:"left",RIGHT:"right"};Mavelous.PFD=function(a){this.init(a)};
...
Mavelous.FakeVehicle.fakeVfrHud=function(a){return{heading:a.heading,alt:a.alt,airspeed:a.velocity}};Mavelous.FakeVehicle.fakeNavControllerOutput=function(a){return{alt_error:30-a.alt,aspd_error:4-a.velocity}};Mavelous.FakeVehicle.fakeGpsRawInt=function(a){return{fix_type:3,lat:Math.round(1E7*a.lat),lon:Math.round(1E7*a.lon)}};Mavelous.FakeVehicle.fakeMetaWaypoint=function(){return{}};Mavelous.FakeVehicle.fakeHeartbeat=function(){return{type:2,base_mode:129,custom_mode:3}};
Mavelous.FakeVehicle.fakeMetaLinkquality=function(a){return{master_in:Math.floor(11*a.t),master_out:Math.floor(9*a.t),mav_loss:0}};Mavelous.FakeVehicle.fakeGpsStatus=function(){return{satellites_visible:8}};Mavelous.FakeVehicle.fakeStatustext=function(){return{text:"Offline mode"}};Mavelous.FakeVehicle.fakeSysStatus=function(){return{}};
...
Mavelous.LeafletView.prototype.updateVehiclePath=function(){var a=this.vehicleModel.get("position");a&&(void 0===this.vehiclePath?(this.vehiclePath=new L.Polyline([a],{color:"red"}),this.vehiclePath.addTo(this.map)):this.vehiclePath.addLatLng(a))};Mavelous.LeafletView.prototype.updateGuideMarker=function(){var a=this.guideModel.toJSON(),b=new L.LatLng(a.lat,a.lon);a&&(void 0===this.guideMarker?(this.guideMarker=new L.Marker(b,{icon:new markerIcon}),this.map.addLayer(this.guideMarker)):this.guideMarker.setLatLng(b))};Mavelous.VehicleLeafletPosition=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.VehicleLeafletPosition,Backbone.Model);Mavelous.VehicleLeafletPosition.prototype.defaults=function(){return{position:null,heading:0}};goog.exportSymbol("Mavelous.VehicleLeafletPosition.prototype.defaults",Mavelous.VehicleLeafletPosition.prototype.defaults);
...
new Mavelous.FlightModeButtonView({el:$("#navbar-btn-mode"),modeModel:this.flightModeModel,commandModel:this.flightCommandModel});this.statusButtons=Mavelous.StatusButtons([this.gpsButtonView,this.commStatusButtonView,this.flightModeButtonView]);this.batteryButton=new Mavelous.BatteryButton({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-battery")});this.settingsView=new Mavelous.SettingsView({map:this.mapView.map,mapProviderModel:this.leafletProviders,vehicleIconModel:this.leafletDroneIcon,modalToggle:$("#navbar-a-settings"),
modal:$("#settings-modal"),mapProviderPicker:$("#settings-mapproviderpicker"),mapZoomSlider:$("#settings-mapzoom"),mapZoomValue:$("#settings-mapzoom-value"),vehicleIconPicker:$("#settings-vehicleiconpicker"),pfdSettingsModel:this.pfdSettingsModel,pfdPositionLeft:$("#settings-pfdpos-left"),pfdPositionRight:$("#settings-pfdpos-right"),pfdPositionUp:$("#settings-pfdpos-up"),pfdPositionDown:$("#settings-pfdpos-down")});this.router=new Mavelous.AppRouter({pfdSettingsModel:this.pfdSettingsModel});Backbone.history.start();
767<$(window).width()?this.router.navigate("overview",{trigger:!0}):this.router.navigate("maponly",{trigger:!0});var d=null,e=new goog.async.Throttle(function(){this.mavlinkAPI.update();d.start()},100,this),d=new goog.async.AnimationDelay(function(){e.fire()});d.start()};goog.exportSymbol("Mavelous.App",Mavelous.App);goog.exportSymbol("Mavelous.App.prototype.start",Mavelous.App.prototype.start);
