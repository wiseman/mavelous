...
d)};Mavelous.SelectedModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.SelectedModel,Backbone.Model);Mavelous.SelectedModel.prototype.defaults=function(){return{selected:!1}};goog.exportSymbol("Mavelous.SelectedModel.prototype.defaults",Mavelous.SelectedModel.prototype.defaults);Mavelous.SelectedModel.prototype.select=function(){this.set("selected",!0)};Mavelous.SelectedModel.prototype.deselect=function(){this.set("selected",!1)};
Mavelous.RadioButtonPopoverView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.RadioButtonPopoverView,Backbone.View);Mavelous.RadioButtonPopoverView.prototype.initialize=function(){this.buttons=_.map(this.options.popovers,goog.bind(this.registerButton_,this))};goog.exportSymbol("Mavelous.RadioButtonPopoverView.prototype.initialize",Mavelous.RadioButtonPopoverView.prototype.initialize);
Mavelous.RadioButtonPopoverView.prototype.registerButton_=function(a,b){var c=new Mavelous.SelectedModel;c.set("index",b);a.$el.click(goog.bind(this.onButtonClick_,this,b));a.selectedModel=c;c.bind("change",a.onSelectedChange,a);return c};Mavelous.RadioButtonPopoverView.prototype.onButtonClick_=function(a){this.buttons[a].get("selected")?this.buttons[a].deselect():(this.buttons[a].select(),_.each(_.without(this.buttons,this.buttons[a]),function(a){a.deselect()}))};
...
goog.events.Listener.prototype.handleEvent=function(a){return this.isFunctionListener_?this.listener.call(this.handler||this.src,a):this.listener.handleEvent.call(this.listener,a)};goog.debug={};goog.debug.errorHandlerWeakDep={protectEntryPoint:function(a){return a}};goog.string={};goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(a,b){return 0==a.lastIndexOf(b,0)};goog.string.endsWith=function(a,b){var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c};goog.string.caseInsensitiveStartsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(0,b.length))};goog.string.caseInsensitiveEndsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(a.length-b.length,b.length))};
...
goog.userAgent.isDocumentMode=function(a){return goog.userAgent.IE&&goog.userAgent.DOCUMENT_MODE>=a};goog.userAgent.DOCUMENT_MODE=function(){var a=goog.global.document;return!a||!goog.userAgent.IE?void 0:goog.userAgent.getDocumentMode_()||("CSS1Compat"==a.compatMode?parseInt(goog.userAgent.VERSION,10):5)}();goog.events.BrowserFeature={HAS_W3C_BUTTON:!goog.userAgent.IE||goog.userAgent.isDocumentMode(9),HAS_W3C_EVENT_SUPPORT:!goog.userAgent.IE||goog.userAgent.isDocumentMode(9),SET_KEY_CODE_TO_PREVENT_DEFAULT:goog.userAgent.IE&&!goog.userAgent.isVersion("9"),HAS_NAVIGATOR_ONLINE_PROPERTY:!goog.userAgent.WEBKIT||goog.userAgent.isVersion("528"),HAS_HTML5_NETWORK_EVENT_SUPPORT:goog.userAgent.GECKO&&goog.userAgent.isVersion("1.9b")||goog.userAgent.IE&&goog.userAgent.isVersion("8")||goog.userAgent.OPERA&&goog.userAgent.isVersion("9.5")||
...
var b=a.type;return!(b in this.eventTargetListeners_)?!1:goog.array.remove(this.eventTargetListeners_[b],a)},goog.events.EventTarget.prototype.removeAllListeners=function(a){var b=0,c;for(c in this.eventTargetListeners_)if(!a||c==a){var d=this.eventTargetListeners_[c],b=b+d.length;d.length=0}return b},goog.events.EventTarget.prototype.fireListeners=function(a,b,c){goog.asserts.assert(!this.isDisposed());if(!(a in this.eventTargetListeners_))return!0;var d=!0;a=goog.array.clone(this.eventTargetListeners_[a]);
...
767<$(window).width()?this.router.navigate("overview",{trigger:!0}):this.router.navigate("maponly",{trigger:!0});var d=null,e=new goog.async.Throttle(function(){this.mavlinkAPI.update();d.start()},100,this),d=new goog.async.AnimationDelay(function(){e.fire()});d.start()};Mavelous.App.prototype.createStatusButtons_=function(a){return new Mavelous.RadioButtonPopoverView({popovers:goog.array.map(a,function(a){return new Mavelous.PopoverView({button:a})})})};goog.exportSymbol("Mavelous.App",Mavelous.App);
