 ...
 * @extends {Backbone.View}
 */
Mavelous.FlightModePopoverDelegateView = function(properties) {
  this.popoverTitle = 'Flight Commands';
  goog.base(this, properties);
};
goog.inherits(Mavelous.FlightModePopoverDelegateView , Backbone.View);

/**
 * @override
 * @export
 */
Mavelous.FlightModePopoverDelegateView.prototype.initialize = function() {
  this.modeModel = this.options['modeModel'];
...
Mavelous.FlightModePopoverDelegateView.prototype.setupPopover = function() {
  var loiter =
...
Mavelous.FlightModePopoverDelegateView.prototype.cleanupSubview = function (subviewname) {
  if (this[subviewname]) {
